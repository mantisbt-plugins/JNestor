//
// CustomMailFilter.groovy
//
// 
// This script is codified as UTF-8 without BOM. For editing purposes. 
//
// Filters the incoming emails based on the subject. It skips 
// many of the emails that are automatic answers. I have many
// custom answers in many languages: spanish, turkish, english 
// and portuguese.
// 
...
class CustomMailFilter implements MailProcessor
{
 	def nestorSubject;

    public void process( MailMessage mailMsg )
    {
		boolean out;
        ...
        mailMsg.setProperty( MailProperty.STOP, ! out );
